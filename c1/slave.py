...
# configurar anomalias de este cliente
cliente.setConfigTests(True, 2, 1, 1, # simular la corrupcion de checksum
                       True, 2, 1, 1, # simular la perdida de paquetes de datos
                       True, 2, 1, 1) # simular perdida de ACKs
cliente.start(args.UDP_IP, args.UDP_PORT) # inicia el socket UDP
